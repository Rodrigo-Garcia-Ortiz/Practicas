...
public class InterfazConsola {
	...
	public int menu() { //Muestra el menú principal
		...
		System.out.println("8. Registrar producto sin nombre");
    ...
    public ProductoOtaku registrarSinNombre() {
    	
    	LlmService asistente = new LlmService();
		...
		System.out.println("Introduce la franquicia del producto:");
		String franquicia = obj.nextLine();
		System.out.println();
		saltoDeLinea = obj.nextLine();
		...
		String nombre = asistente.sugerirNombreProducto(categoria, franquicia);
